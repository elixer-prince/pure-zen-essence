...
const HeroSection = () => {
  return (
    <header className="mt-24 grid h-[calc(100dvh-6rem)] grid-cols-1 items-center gap-8 bg-[url('./src/assets/')] bg-cover bg-fixed bg-center bg-no-repeat px-8 py-24 md:grid-cols-4 md:py-8">
      {/* Left Container */}
