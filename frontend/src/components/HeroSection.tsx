...
const HeroSection = () => {
  return (
    // HERO SECTION
    <header className="mt-24 flex h-fit items-center p-4 pb-30 sm:pt-16 md:py-30">
        {/* Left Container */}
      <section className="flex flex-col items-center gap-16 pt-[1px]">
        ...
        <div className="flex gap-4 font-bold text-white">
            <a
            className="to-brand-darkblue flex items-center gap-1 rounded-xl bg-linear-to-r from-black p-4"
              href="#about"
            >
            Learn More <FaArrowDown className="hidden text-xl sm:block" />
            </a>
            <a
            className="to-brand-blue from-brand-green flex items-center gap-1 rounded-xl bg-linear-to-r p-4"
              href="#contact"
            >
      ...
      <div className="col-span-2 hidden h-full items-center justify-center lg:flex">
        <img src="" alt="Image of a beautiful woman should go here..." />      </div>
    </header>
  );
};
