...
const AboutSection = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 aspect-square min-h-[calc(100dvh-6rem] w-[12rem] flex-1/2 -translate-x-1/2 -translate-y-[50%] overflow-hidden rounded-full border-4 border-white lg:static lg:w-1/2 lg:translate-0">
        <AboutImage />
      </div>
