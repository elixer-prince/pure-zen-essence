<x-layouts.app>
    <x-slot:page-title>Pure Zen Essence | Admin Login</x-slot:page-title>
    <x-slot:page-description>Login as an admin to Pure Zen Essence.</x-slot:page-description>

    <main class="min-h-full">
        <x-section id="login" class="flex px-8 py-16 sm:px-16 items-center justify-center"
            aria-labelledby="login-header">
            <x-form class="border-2 max-w-120 w-full border-neutral-500 rounded-lg p-8 sm:p-16" action="/admin/login"
                method="POST">
